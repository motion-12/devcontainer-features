...
check "kubectl completion zsh" grep -q "kubectl completion zsh" /home/node/.zshrc
# Check kubectl completion is on .bashrc
check "kubectl completion bash" grep -q "kubectl completion bash" /home/node/.bashrc
